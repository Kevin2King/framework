...
public class Tokeninfo extends PayPalResource {
	...
	/**
	 * @param createFromAuthorizationCodeParameters Query parameters used for API call
	 * @return Tokeninfo
	 ...
	 *
	 * @param apiContext {@link APIContext} to be used for the call.
	 * @param code       Code returned from PayPal redirect.
	 * @return Tokeninfo
	 * @throws PayPalRESTException
	 */
	public static Tokeninfo createFromAuthorizationCode(APIContext apiContext, String code) throws PayPalRESTException {
		String pattern = "v1/identity/openidconnect/tokenservice?grant_type={0}&code={1}&redirect_uri={2}";
	...
	private static Tokeninfo createFromAuthorizationCodeParameters(APIContext apiContext, CreateFromAuthorizationCodeParameters createFromAuthorizationCodeParameters, String resourcePath) throws PayPalRESTException {
		...
		authorizationHeader = oauthTokenCredential.getAuthorizationHeader();
		...
		headersMap.put(Constants.HTTP_ACCEPT_HEADER, Constants.HTTP_CONTENT_TYPE_JSON);
		apiContext.addHTTPHeaders(headersMap);
		Tokeninfo tokeninfo = configureAndExecute(apiContext, HttpMethod.POST, resourcePath, payLoad, Tokeninfo.class, authorizationHeader);
		apiContext.setRequestId(null);
		return tokeninfo;
	}
	 ...
	 *
	 * @param createFromRefreshTokenParameters Query parameters used for API call
	 * @return Tokeninfo
	 * @throws PayPalRESTException
	 */
	...
	public Tokeninfo createFromRefreshTokenForFpp(APIContext apiContext) throws PayPalRESTException {
		...
		apiContext.addHTTPHeaders(headersMap);
		Tokeninfo tokeninfo = configureAndExecute(apiContext, HttpMethod.POST, resourcePath, payLoad, Tokeninfo.class);
		apiContext.setRequestId(null);
		return tokeninfo;
	}
}
