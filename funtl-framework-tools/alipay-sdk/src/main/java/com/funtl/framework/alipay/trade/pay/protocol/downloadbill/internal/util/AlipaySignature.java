...
import com.funtl.framework.alipay.trade.pay.protocol.downloadbill.internal.codec.Base64;
...
public class AlipaySignature {
	...
	public static String rsaEncrypt(String content, String publicKey, String charset) throws AlipayApiException {
		try {
			PublicKey pubKey = getPublicKeyFromX509(AlipayConstants.SIGN_TYPE_RSA, new ByteArrayInputStream(publicKey.getBytes()));
