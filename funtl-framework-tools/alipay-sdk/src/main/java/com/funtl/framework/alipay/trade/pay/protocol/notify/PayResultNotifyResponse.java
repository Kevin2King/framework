...
public class PayResultNotifyResponse {
	...
	public String toString() {
		return "PayResultNotifyResponse{" + "notify_time='" + notify_time + '\'' + ", notify_type='" + notify_type + '\'' + ", notify_id='" + notify_id + '\'' + ", sign_type='" + sign_type + '\'' + ", sign='" + sign + '\'' + ", out_trade_no='" + out_trade_no + '\'' + ", subject='" + subject + '\'' + ", payment_type='" + payment_type + '\'' + ", trade_no='" + trade_no + '\'' + ", trade_status='" + trade_status + '\'' + ", gmt_create='" + gmt_create + '\'' + ", gmt_payment='" + gmt_payment + '\'' + ", gmt_close='" + gmt_close + '\'' + ", refund_status='" + refund_status + '\'' + ", gmt_refund='" + gmt_refund + '\'' + ", seller_email='" + seller_email + '\'' + ", buyer_email='" + buyer_email + '\'' + ", seller_id='" + seller_id + '\'' + ", buyer_id='" + buyer_id + '\'' + ", price='" + price + '\'' + ", total_fee='" + total_fee + '\'' + ", quantity='" + quantity + '\'' + ", body='" + body + '\'' + ", discount='" + discount + '\'' + ", is_total_fee_adjust='" + is_total_fee_adjust + '\'' + ", use_coupon='" + use_coupon + '\'' + ", extra_common_param='" + extra_common_param + '\'' + ", business_scene='" + business_scene + '\'' + '}';
	}
}
