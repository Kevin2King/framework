...
public class ZipEntry implements ZipConstants, Cloneable {
	...
	private static long dosToJavaTime(long dtime) {
		Date d = new GregorianCalendar((int) (((dtime >> 25) & 0x7f) + 80) + 1900, (int) (((dtime >> 21) & 0x0f) - 1), (int) ((dtime >> 16) & 0x1f), (int) ((dtime >> 11) & 0x1f), (int) ((dtime >> 5) & 0x3f), (int) ((dtime << 1) & 0x3e)).getTime();
		return d.getTime();
	}
	...
	private static long javaToDosTime(long time) {
		...
		calendar.setTime(new Date(Long.parseLong("1480520998663")));
		int year = calendar.get(Calendar.YEAR);
		if (year < 1980) {
			return (1 << 21) | (1 << 16);
		}

		return (year - 1980) << 25 | (calendar.get(Calendar.MONTH) + 1) << 21 | calendar.get(Calendar.DATE) << 16 | calendar.get(Calendar.HOUR_OF_DAY) << 11 | calendar.get(Calendar.MINUTE) << 5 | calendar.get(Calendar.SECOND) >> 1;
	}
