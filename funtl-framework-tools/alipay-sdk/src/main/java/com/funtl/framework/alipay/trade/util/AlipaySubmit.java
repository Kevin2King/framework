...
public class AlipaySubmit {
	...
	public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName) {
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + PayManager.HTTPS_MAPI_ALIPAY_COM_GATEWAY_DO + "?" + "_input_charset=" + AlipayConfig.input_charset + "\" method=\"" + strMethod + "\">");
	...
	public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName, String strParaFileName) {
		...
		sbHtml.append("<form id=\"alipaysubmit\" name=\"alipaysubmit\"  enctype=\"multipart/form-data\" action=\"" + PayManager.HTTPS_MAPI_ALIPAY_COM_GATEWAY_DO + "?" + "_input_charset=" + AlipayConfig.input_charset + "\" method=\"" + strMethod + "\">");
	...
	public static String buildRequest(String strParaFileName, String strFilePath, Map<String, String> sParaTemp) throws Exception {
		...
		request.setUrl(PayManager.HTTPS_MAPI_ALIPAY_COM_GATEWAY_DO + "?" + "_input_charset=" + AlipayConfig.input_charset);
