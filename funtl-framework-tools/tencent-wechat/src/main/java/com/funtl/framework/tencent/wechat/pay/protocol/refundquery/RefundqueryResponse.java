...
package com.funtl.framework.tencent.wechat.pay.protocol.refundquery;
...
public class RefundqueryResponse {
	...
	public String toString() {
		return "RefundqueryResponse{" + "result_code='" + result_code + '\'' + ", err_code='" + err_code + '\'' + ", err_code_des='" + err_code_des + '\'' + ", appid='" + appid + '\'' + ", mch_id='" + mch_id + '\'' + ", device_info='" + device_info + '\'' + ", nonce_str='" + nonce_str + '\'' + ", sign='" + sign + '\'' + ", transaction_id='" + transaction_id + '\'' + ", out_trade_no='" + out_trade_no + '\'' + ", total_fee=" + total_fee + ", fee_type='" + fee_type + '\'' + ", cash_fee=" + cash_fee + ", refund_count=" + refund_count + ", out_refund_no_$n=" + Arrays.toString(out_refund_no_$n) + ", refund_id_$n=" + Arrays.toString(refund_id_$n) + ", refund_channel_$n=" + Arrays.toString(refund_channel_$n) + ", refund_fee_$n=" + Arrays.toString(refund_fee_$n) + ", coupon_refund_fee_$n=" + Arrays.toString(coupon_refund_fee_$n) + ", coupon_refund_count_$n=" + Arrays.toString(coupon_refund_count_$n) + ", coupon_refund_batch_id_$n_$m=" + Arrays.toString(coupon_refund_batch_id_$n_$m) + ", coupon_refund_id_$n_$m=" + Arrays.toString(coupon_refund_id_$n_$m) + ", coupon_refund_fee_$n_$m=" + Arrays.toString(coupon_refund_fee_$n_$m) + ", refund_status_$n=" + Arrays.toString(refund_status_$n) + '}';
	}
}
