...
public class User {
	...
	public String toString() {
		return "User [subscribe=" + subscribe + ", openId=" + openId + ", nickName=" + nickName + ", sex=" + sex + ", city=" + city + ", country=" + country + ", province=" + province + ", language=" + language + ", headimgUrl=" + headimgUrl + ", subscribeTime=" + subscribeTime + ", unionId=" + unionId + ", remark=" + remark + ", groupId=" + groupId + "]";
	}
