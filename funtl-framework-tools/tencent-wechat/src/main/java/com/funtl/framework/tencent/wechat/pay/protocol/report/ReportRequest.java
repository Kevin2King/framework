...
public class ReportRequest {
	...
	public String toString() {
		return "ReportRequest{" + "appid='" + appid + '\'' + ", mch_id='" + mch_id + '\'' + ", device_info='" + device_info + '\'' + ", nonce_str='" + nonce_str + '\'' + ", sign='" + sign + '\'' + ", interface_url='" + interface_url + '\'' + ", execute_time_='" + execute_time_ + '\'' + ", return_code='" + return_code + '\'' + ", return_msg='" + return_msg + '\'' + ", result_code='" + result_code + '\'' + ", err_code='" + err_code + '\'' + ", err_code_des='" + err_code_des + '\'' + ", out_trade_no='" + out_trade_no + '\'' + ", user_ip='" + user_ip + '\'' + ", time='" + time + '\'' + '}';
	}
}
